...
public static double computeHyperVolume(
    ...
    for (Object chromosome : sortedFront) {
        ...
        System.out.printf("Chromosome F1: %.3f, F2: %.3f%n", currentF1, currentF2);
        ...
        System.out.printf("Width: %.3f, Height: %.3f%n", width, height);
        ...
        if (width > 0 && height > 0) {
            ...
            System.out.printf("Area: %.3f, Cumulative HyperVolume: %.3f%n", area, hyperVolume);
        } else {
    ...
    System.out.printf("Final HyperVolume: %.3f%n", hyperVolume);
    return hyperVolume;
}
