...
public class Main implements Callable<Integer> {
    ...
    List<String> getTestCaseNamesFrom(final Chromosome<?> testSuiteChromosome) {
        // Downcast Chromosome<?> to TestSuiteChromosome
        TestSuiteChromosome chromosome = (TestSuiteChromosome) testSuiteChromosome;
    
        List<String> names = new ArrayList<>();
        for (Integer testCaseIndex : chromosome.getTestCases()) {
            names.add(testCases[testCaseIndex]); // Use the testCases array to get names
        }
...
double getCoverageOf(final Chromosome<?> testSuiteChromosome) {
    ...
    // Compute and return normalized coverage fitness
    return chromosome.getCoverageFitness(coverageMatrix);
}
...
double getSizeOf(final Chromosome<?> testSuiteChromosome) {
    ...
    // Return normalized size fitness
    return chromosome.getSizeFitness();
}
