...
private GeneticAlgorithm<TestSuiteChromosome> buildNSGA2() {
    // Create operators
    TestSuiteMutation mutation = new TestSuiteMutation(0.1); // Mutation probability = 10%
    TestSuiteCrossover crossover = new TestSuiteCrossover();
    BinaryTournamentSelection<TestSuiteChromosome> selection = 
        new BinaryTournamentSelection<>(
            ((FitnessFunction<TestSuiteChromosome>) sizeFF).comparator(),
            Randomness.random()
        );
    ...
    return new NSGA2(
            ...
            crossover,
            selection,
            new TestSuiteSizeFitnessFunction(),         // Minimize size fitness function
            new TestSuiteCoverageFitnessFunction(coverageMatrix), // Maximize coverage fitness function
            numberTestCases
    );
}
    ...
    private GeneticAlgorithm<TestSuiteChromosome> buildRandomSearch() {
        ...
        Mutation<TestSuiteChromosome> mutation = new TestSuiteMutation(0.1); // Mutation probability: 10%
        ...
        // Fitness functions
        TestSuiteSizeFitnessFunction sizeFitnessFunction = new TestSuiteSizeFitnessFunction();
        TestSuiteCoverageFitnessFunction coverageFitnessFunction = new TestSuiteCoverageFitnessFunction(coverageMatrix);
    
        // Return RandomSearch instance
