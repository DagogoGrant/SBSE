...
public class RandomSearch implements GeneticAlgorithm<TestCase> {
    ...
    public List<TestCase> findSolution(){
        ...
        while (!stoppingCondition.searchMustStop()) {
            ...
            System.out.println("The archive size is: " + archive.size());

            // Combine the archive with the population
            // In order to come up with a combined evaluation map
            List<TestCase> combinedTestCases = new ArrayList<>(population);
