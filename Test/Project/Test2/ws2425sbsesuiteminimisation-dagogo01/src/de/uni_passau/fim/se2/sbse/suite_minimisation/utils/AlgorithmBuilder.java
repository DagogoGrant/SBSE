...
private Crossover<TestSuiteChromosome> crossover;
    ...
    this.mutation = new BitFlipMutation(random);
    this.crossover = new SinglePointCrossover(random);
    }
    public void setMutation(Mutation<TestSuiteChromosome> mutation) {
        this.mutation = mutation;
    }
    
    public void setCrossover(Crossover<TestSuiteChromosome> crossover) {
    ...
    private MinimizingFitnessFunction<? extends Chromosome<?>> makeTestSuiteSizeFitnessFunction() {
        return new SizeFitnessFunction(numberTestCases);
    }
