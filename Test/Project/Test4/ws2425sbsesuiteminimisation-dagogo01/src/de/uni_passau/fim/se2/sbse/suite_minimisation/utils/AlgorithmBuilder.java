...
public class AlgorithmBuilder {
    ...
    private Mutation<TestSuiteChromosome> mutationOperator;
private Crossover<TestSuiteChromosome> crossoverOperator;
    ...
    private GeneticAlgorithm<? extends Chromosome<?>> buildRandomSearch() {
        ...
        Mutation<TestSuiteChromosome> mutation = new TestSuiteMutation(0.1, random); // Pass mutation probability and random
        Crossover<TestSuiteChromosome> crossover = new TestSuiteCrossover(random); // Pass random if required by TestSuiteCrossover
