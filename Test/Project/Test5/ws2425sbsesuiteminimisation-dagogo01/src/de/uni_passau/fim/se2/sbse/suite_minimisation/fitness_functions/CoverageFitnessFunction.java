...
public class CoverageFitnessFunction implements MaximizingFitnessFunction<TestSuiteChromosome> {
    ...
    public CoverageFitnessFunction(boolean[][] coverageMatrix, double weightCoefficient) {
        ...
        System.out.println("Initializing CoverageFitnessFunction:");
        System.out.println("- Matrix Rows: " + coverageMatrix.length);
        System.out.println("- Matrix Columns (first row): " + coverageMatrix[0].length);
        System.out.println("- Weight Coefficient: " + weightCoefficient);
    ...
    public double applyAsDouble(TestSuiteChromosome chromosome) {
        ...
        double fitness = Math.min(1.0, normalizedCoverage + weightCoefficient * normalizedWeight);
