...
public class AlgorithmBuilder {
    private static final int totalTestCases = 100; // Number of test cases
    private static final int maxFitnessEvaluations = 5000; // Maximum fitness evaluations
     // Example matrix; replace with your actual coverage matrix
    /**
    ...
    private MinimizingFitnessFunction<TestSuiteChromosome> makeTestSuiteSizeFitnessFunction() {
        int totalTestCases = coverageMatrix.length; // Assuming `coverageMatrix` is available and represents total test cases.
        return new SizeFitnessFunction(totalTestCases);
    }
    ...
    private GeneticAlgorithm<? extends Chromosome<?>> buildRandomSearch() {
        ...
        TestSuiteChromosomeGenerator generator = new TestSuiteChromosomeGenerator(
                totalTestCases, // Ensure this is defined
                mutation,
                crossover
        );
    
        // Instantiate the fitness functions
        SizeFitnessFunction sizeFitnessFunction = new SizeFitnessFunction(totalTestCases);
        CoverageFitnessFunction coverageFitnessFunction = new CoverageFitnessFunction(coverageMatrix);
