...
public class AlgorithmBuilder {
    ...
    private MinimizingFitnessFunction<TestSuiteChromosome> makeTestSuiteSizeFitnessFunction() {
        return new TestSuiteSizeFitnessFunction<>(numberTestCases);
    }
...
private GeneticAlgorithm<? extends Chromosome<?>> buildRandomSearch() {
    ...
    Mutation<TestSuiteChromosome> mutation = new TestSuiteMutation(); // Default constructor
    ...
    FitnessFunction<TestSuiteChromosome> sizeFitnessFunction = new TestSuiteSizeFitnessFunction(numberTestCases);
