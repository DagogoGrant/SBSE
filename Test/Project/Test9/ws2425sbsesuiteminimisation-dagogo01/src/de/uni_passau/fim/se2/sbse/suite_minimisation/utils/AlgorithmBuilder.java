...
public class AlgorithmBuilder {
    ...
    private MinimizingFitnessFunction<TestSuiteChromosome> makeTestSuiteSizeFitnessFunction() {
        double sizeWeight = 0.00; // Assign an appropriate weight (e.g., 50%)
    ...
    private MaximizingFitnessFunction<TestSuiteChromosome> makeTestSuiteCoverageFitnessFunction() {
        double weightCoefficient = 0.10; // Adjust this value based on your desired weighting
    ...
    private GeneticAlgorithm<TestSuiteChromosome> buildNSGA2() {
        double sizeWeight = 0.00; // Adjusted weight for size
        double weightCoefficient = 0.10; // Adjusted weight for coverage
...
private GeneticAlgorithm<TestSuiteChromosome> buildRandomSearch() {
    ...
    CoverageTracker coverageTracker = new CoverageTracker(
        TestSuiteChromosome.class,        // Replace with your actual CUT class
        TestSuiteChromosomeGenerator.class // Replace with your actual test suite class
    );

    // Chromosome generator with Random argument
    TestSuiteChromosomeGenerator generator = new TestSuiteChromosomeGenerator(
        numberTestCases,
        coverageTracker,
        mutation,
        crossover,
        random // Pass the Random instance here
    );

    // Fitness functions
    double sizeWeight = 0.00; // Example weight for the size fitness function
    SizeFitnessFunction sizeFitnessFunction = new SizeFitnessFunction(sizeWeight);
    double weightCoefficient = 0.10; 
    CoverageFitnessFunction coverageFitnessFunction = new CoverageFitnessFunction(coverageMatrix, weightCoefficient);
