...
class SimpleGeneticAlgorithmTest {
    ...
    void testInitializePopulation() {
        ...
        assertEquals(SimpleGeneticAlgorithm.POPULATION_SIZE, population.size());
    }
    ...
    void testEvaluatePopulation() {
        ...
        assertNotNull(geneticAlgorithm.getPopulation());
    }
    ...
    void testElitism() {
        ...
        assertFalse(elitePopulation.isEmpty());
    }
    ...
    void testSetAndGetPopulation() {
        ...
        assertEquals(SimpleGeneticAlgorithm.POPULATION_SIZE, geneticAlgorithm.getPopulation().size());
    }
