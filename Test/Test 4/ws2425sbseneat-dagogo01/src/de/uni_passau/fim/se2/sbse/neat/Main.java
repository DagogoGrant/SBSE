...
public class Main implements Callable<Integer> {
    ...
    @CommandLine.Option(
        ...
        defaultValue = "200"  // Increased from 100
    )
    ...
    @Override
public Integer call() {
    System.out.println("Debug: Initial population size = " + populationSize);
    System.out.println("Debug: Initial max generations = " + maxGenerations);

    // Input validation
    if (populationSize <= 0 || maxGenerations <= 0 || repetitions <= 0) {
        System.err.println("Error: Population size, max generations, and repetitions must be positive.");
        return 1;
    }
    ...
    System.out.println("Debug: Final population size = " + populationSize);
    System.out.println("Debug: Final max generations = " + maxGenerations);
    ...
    private void solveTask() {
        ...
        boolean isSolved = environment.solved(solution);
        successes.add(isSolved);
        solutions.add(solution);
    
        System.out.println("Task completed. Generations: " + neat.getGeneration() + 
                           ", Time: " + (endTime - startTime) / 1000.0 + "s, Solved: " + isSolved);
    }
    /**
...
public static Neuroevolution initialiseNeat(int populationSize, int maxGenerations) {
    ...
    // Create and return a new NeatAlgorithm instance
    return new NeatAlgorithm(populationSize, maxGenerations, random);
}
