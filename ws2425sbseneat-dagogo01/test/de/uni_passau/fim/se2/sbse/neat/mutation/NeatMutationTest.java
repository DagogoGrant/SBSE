...
import de.uni_passau.fim.se2.sbse.neat.algorithms.innovations.*;
...
class NeatMutationTest {
    ...
    @Test
    void testApply_NoMutation() {
        random = new Random() {
            @Override
            public double nextDouble() {
                return 1.0;  // Ensure no mutation happens
            }
        };
        mutation = new NeatMutation(innovations, random);
        NetworkChromosome result = mutation.apply(testNetwork);
        assertEquals(testNetwork, result, "Expected no mutation to be applied.");
    }

    @Test
    void testApply_AddNeuronMutation() {
        random = new Random() {
            @Override
            public double nextDouble() {
    ...
    @Test
    void testApply_AddConnectionMutation() {
        random = new Random() {
            @Override
            public double nextDouble() {
    ...
    @Test
void testApply_ToggleConnection() {
    random = new Random() {
        @Override
        public double nextDouble() {
    ...
    @Test
    void testAddNeuron_NoConnections() {
    ...
    @Test
    void testAddConnection_FullyConnected() {
    ...
    @Test
    void testMutateWeights_WithinBounds() {
    ...
    @Test
    void testToggleConnection_NoConnections() {
        NetworkChromosome emptyNetwork = new NetworkChromosome(new HashMap<>(), new ArrayList<>());
