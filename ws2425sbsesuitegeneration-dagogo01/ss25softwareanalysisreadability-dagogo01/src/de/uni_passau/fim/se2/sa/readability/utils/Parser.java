...
public class Parser {
     ...
     * @throws ParseException if the code snippet could not be parsed by the JavaParser library or if input is nulll.
     */
    public static BodyDeclaration<?> parseJavaSnippet(String codeSnippet) throws ParseException {
        if (codeSnippet == null) {
            throw new ParseException("Cannot parse null input");
        }
